...
static STextureDB sTextures[] =
{
	...
	STextureDB(PARAM(TM_Layer1_Diffuse,               ECGT_MatSlot_LAYER1_DIFFUSE),       0),
	STextureDB(PARAM(TM_Layer1_Normals,               ECGT_MatSlot_LAYER1_NORMALS),       0),
	STextureDB(PARAM(TM_Layer2_Diffuse,               ECGT_MatSlot_LAYER2_DIFFUSE),       0),
	STextureDB(PARAM(TM_Layer2_Normals,               ECGT_MatSlot_LAYER2_NORMALS),       0),
	STextureDB(PARAM(TM_Layer3_Diffuse,               ECGT_MatSlot_LAYER3_DIFFUSE),       0),
	STextureDB(PARAM(TM_Layer3_Normals,               ECGT_MatSlot_LAYER3_NORMALS),       0),
	STextureDB(PARAM(TM_Layer4_Diffuse,               ECGT_MatSlot_LAYER4_DIFFUSE),       0),
	STextureDB(PARAM(TM_Layer4_Normals,               ECGT_MatSlot_LAYER4_NORMALS),       0),

	STextureDB(PARAM(TM_Layer1_WT_Diffuse,               ECGT_MatSlot_LAYER1_WT_DIFFUSE),       0),
	STextureDB(PARAM(TM_Layer1_WT_Normals,               ECGT_MatSlot_LAYER1_WT_NORMALS),       0),
	STextureDB(PARAM(TM_Layer2_WT_Diffuse,               ECGT_MatSlot_LAYER2_WT_DIFFUSE),       0),
	STextureDB(PARAM(TM_Layer2_WT_Normals,               ECGT_MatSlot_LAYER2_WT_NORMALS),       0),
	STextureDB(PARAM(TM_Layer3_WT_Diffuse,               ECGT_MatSlot_LAYER3_WT_DIFFUSE),       0),
	STextureDB(PARAM(TM_Layer3_WT_Normals,               ECGT_MatSlot_LAYER3_WT_NORMALS),       0),
	STextureDB(PARAM(TM_Layer4_WT_Diffuse,               ECGT_MatSlot_LAYER4_WT_DIFFUSE),       0),
	STextureDB(PARAM(TM_Layer4_WT_Normals,               ECGT_MatSlot_LAYER4_WT_NORMALS),       0),

	STextureDB(PARAM(TM_Layer1_Smoothness,               ECGT_MatSlot_LAYER1_SMOOTHNESS),       0),
	STextureDB(PARAM(TM_Layer2_Smoothness,               ECGT_MatSlot_LAYER2_SMOOTHNESS),       0),
	STextureDB(PARAM(TM_Layer3_Smoothness,               ECGT_MatSlot_LAYER3_SMOOTHNESS),       0),
	STextureDB(PARAM(TM_Layer4_Smoothness,               ECGT_MatSlot_LAYER4_SMOOTHNESS),       0),

	STextureDB(PARAM(TM_Layer1_WT_Smoothness,               ECGT_MatSlot_LAYER1_WT_SMOOTHNESS),       0),
	STextureDB(PARAM(TM_Layer2_WT_Smoothness,               ECGT_MatSlot_LAYER2_WT_SMOOTHNESS),       0),
	STextureDB(PARAM(TM_Layer3_WT_Smoothness,               ECGT_MatSlot_LAYER3_WT_SMOOTHNESS),       0),
	STextureDB(PARAM(TM_Layer4_WT_Smoothness,               ECGT_MatSlot_LAYER4_WT_SMOOTHNESS),       0),
